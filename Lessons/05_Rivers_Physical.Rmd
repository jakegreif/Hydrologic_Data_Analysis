...
> Discharge, gage height, precipitation, temperature

What is the period of record for mean daily discharge at each of these sites?

> Eno River: 10/1/1928-9/10/2019

> Verde River: 6/18/1915-9/10/2019

> Bitterroot River: 7/26/2001-9/10/2019

> Sauk River: 7/1/1909-9/10/2019

> Nehalem River: 4/1/2937-9/10/2019
...
> Eno (Haw) is much larger than the rest. Nehalem, Sauk, and Verde are similar in that they have lower discharge compared to the others. Bitterroot is alone in the middle range.
...
> Bitterroot (Montana) and Nehalem have clear seasonal discharge, likely due to Spring melt and winter precipitation, respectively. The Sauk river has a seasonal cycle of snowmelt at the beginning of the study period, but potential warming in the region has disrupted that cycle.
...
> Use the function 'rbind' to stack the data sets into one dataframe. Then facet by site name/ID.
...
BitterrootDischarge.Historical <- mutate(BitterrootDischarge.Historical, 
                                         DOY = yday(Date))
# yday extracts the day of year from date
...
# here we group the discharges by the day of year and calculate the max, min, and avg
...
> We would have to place a mathematical formula into the summarise function
...
> Know what's expected, look at the confidence intervals in addition to max/min to more clearly ID outliers
