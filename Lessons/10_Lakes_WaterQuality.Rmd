...
> Variable 1: LULC 500m cropland (LULC 21)  

> Variable 2: Atmospheric Deposition of N

> Variable 3: Chlorophyll a
...
LAGOS.nut$lagoslakeid <- as.factor(LAGOS.nut$lagoslakeid)
LAGOS.chag$lagoslakeid <- as.factor(LAGOS.chag$lagoslakeid)
